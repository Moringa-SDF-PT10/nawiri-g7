...
const lessons = [
    { id: 1, title: 'React Components', course: 'Introduction to React', duration: '30 min' },
    { id: 2, title: 'State and Props', course: 'Introduction to React', duration: '45 min' },
    { id: 3, title: 'Hooks', course: 'Introduction to React', duration: '60 min' },
    { id: 4, title: 'Closures', course: 'Advanced JavaScript', duration: '40 min' },
